...
<CodeSnippetComponentPlayground componentName="HelloWorld" />
...
```ts
import { Component, h } from "shingo";
...
```tsx
import { Component, DangerousHtml } from "shingo";
...
<CodeSnippetComponentPlayground componentName="DangerousDiv" />
